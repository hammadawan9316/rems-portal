...
class QuotationController extends BaseApiController
{
    ...
    public function squareInvoiceByQuotation(int $id)
    {
        ...
        try {
            ...
            return $this->res->ok($detail, 'Square invoice retrieved successfully for quotation.');
        } catch (\Throwable $exception) {
            return $this->res->serverError('Unable to retrieve Square invoice for quotation: ' . $exception->getMessage());
        }
    }
